...
const APIKeys = () => {
          ...
          const [currentPage, setCurrentPage] = useState(1);
            const [allKeyList, setAllKeyList] = useState({
              ...
              allKeyList?.data?.forEach((elem, index) => {
                const { amount, from, to, aiCredits , apiCalls , tokenUsage} =
                  elem;
                let obj = [
                  {
                    value: (
                          ...
                          <h6 className="mb-2 text-14-600">{amount}</h6>
    ...
    const validationSchema = Yup.object({
        ...
        Chatgaptapikey: Yup.string()
              .required("Api Key is required"),
              semanticscholarkeyapi: Yup.string()
              .required("Api Key is required"),
              googletranslationkeyapi: Yup.string()
              .required("Api Key is required"),
              textTospeechapikey: Yup.string()
              .required("Api Key is required"),
                      ...
                      <div className="col-lg-6 col-12">
                        <div className="mb-24 mt-16">
                          <Dropdown
                            ...
                            error={
                              touched.gptModel && errors.gptModel
                            }
                            labelClass="pb-9"
                          />
                        </div>
                      ...
                      <div className="col-lg-6 col-12">
                        <div className="mb-24 mt-16">
                          <TextInput
                            ...
                            error={touched.Chatgaptapikey && errors.Chatgaptapikey}
                      ...
                      <div className="col-12">
                        <div className="mb-24 mt-16">
                          <TextInput
                            ...
                            onChange={handleChange}
                            error={touched.semanticscholarkeyapi && errors.semanticscholarkeyapi}
                      ...
                      <div className="col-12">
                        <div className="mb-24 mt-16">
                          <TextInput
                            ...
                            onChange={handleChange}
                            error={touched.googletranslationkeyapi && errors.googletranslationkeyapi}
                      ...
                      <div className="col-12">
                        <div className="mb-24 mt-16">
                          <TextInput
                            ...
                            onChange={handleChange}
                            error={touched.textTospeechapikey && errors.textTospeechapikey}
