...
const EmailVerification = () => {
    ...
    const handleOTPChange = (e, index, otp, setFieldValue) => {
        ...
        if (/^\d$/.test(value)) {
            ...
            const updatedOtp = otp.substring(0, index) + value + otp.substring(index + 1);
                                            ...
                                            >
                                                ...
                                                <div className='otp-veri d-flex align-items-center justify-content-between'>
                                                    ...
                                                    {[0, 1, 2, 3].map((index) => (
                                                        <input
                                                            ...
                                                            onChange={(e) => handleOTPChange(e, index, values.otp, setFieldValue)}
                                                            onKeyDown={(e) => handleKeyDown(e, index, values.otp, setFieldValue)}
                                                    ...
                                                    <div>
                                                        <p className='text-14-500 color-113D'>Resend OTP</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-18 nevi-login">
                                                    <p className="text-center mt-8 text-16-400 color-3333">
                                                        Go back to <span className="back-login color-113D" onClick={()=>{
                                                            navigate("/login")
                                                        }}>Login</span>
                                                    </p>
                                                </div>
