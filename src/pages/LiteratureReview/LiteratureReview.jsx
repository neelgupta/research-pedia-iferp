...
const LiteratureReview = () => {
  ...
  // Toggle between showing all papers or just the first 3
  const toggleShowAll = () => {
    setShowAll(!showAll);
  };

  // Slice the papers array to only show the first 3 if `showAll` is false
  ...
  return (
    <div>
      ...
      <div className="search-histroy d-flex  justify-content-center">
        ...
        {searchresponse && (
          <div className="search-response brave-scroll-gry">
            <div className="d-flex gap-2">
              ...
              <div className="d-flex">
                <div>
                  <span className="text-16-600 color-113D">5 papers</span>
                </div>
                <div className="position-relative">
                  ...
                  {dropdownOpen && (
                    <div className="dropdown">
                      {dropdownOpen && (
                        <div className="dropdown-menus position-absolute top-0 start-0">
