                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-14-400 color-3333">
                          Join us for a 30 min session where you can share your
                          feedback and ask us any queries you have
                        </p>
                      </div>
                                ...
                                <div className="col-10">
                                  <div className="w-d">
                                    ...
                                    <p className="post-pra">
                                      Journal of Islamic Contemporary Accounting
                                      and Business | VOL. 1
                                    </p>
                                  </div>
                                </div>
                  ...
                  {!isSide && (
                    <>
                      ...
                      <div>
                                ...
                                <div className="about-box-inner">
                                  <div className="author-details">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-14-400 color-3333">
                                        Academy of Special Education named after
                                        Maria Grzegorzewska in Warsaw / Maria
                                        Grzegorzewska University, Institute of
                                      ...
                                      <div className="mt-10">
                                        ...
                                        <div className="fb-center mb-8">
                                          ...
                                          <p className="text-16-600 color-3333">
                                            {authdatadetails?.data1?.co_authors
                                              ? authdatadetails?.data1
                                                  ?.co_authors
                                              : "-"}
                                          </p>
                        ...
                        >
                          {paperAuthdetails && paperAuthdetails?.length > 2 && (
                            <>
