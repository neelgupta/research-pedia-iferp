          ...
          <div className="summary-section">
            <div className="row">
              ...
              <div className="col-12">
                <div className="Abstract-model p-32 brave-scroll-gry mb-30">
                  <div className="mb-26">
                    <h1 className="text-24-500 color-0303">Abstract</h1>
                  </div>
                  <div className="mb-20">
                    <p className="text-20-400 color-3333">
                      Purpose Islamic financial institutions (IFIs) in Malaysia
                      continue to promote Shari‘ah-compliant business and
                      transactions. As a result, the governors have a lot to
                      think about before issuing any fatwa or ordinance, which
                      impacts the majority of Malaysians. Nevertheless, the
                      point of views from the governors have not been
                      highlighted much. This research seeks to investigate the
                      extent to which the conception of al-Siyasah al-Shar‘iyyah
                      is embraced by Shari‘ah committees’ leadership roles
                      within IFIs. The importance of al-Siyasah al-Shar‘iyyah in
                      decision-making makes abandoning the Shari‘ah principle
                      untenable and its significant role for IFIs in Malaysia
                      cannot be overstated. It serves as a crucial tool for
                      ...
                      how Shari‘ah committees in IFIs structuring a set of rules
                      and regulations embedded by al-Siyasah al-Shar‘iyyah
                      elements to produce maṣlaḥaḥ for the ummah. This
                      perspective is barely discussed in depth as Malaysia has
                      unanimous scholars who work in this area. Thus, the
                      authors attempt to bring the discussion academically and
                      express the point of view from governors’ perspective.
                      Originality/value In the Malaysian context, where Islamic
                      banks and financial institutions are overseen by Shari‘ah
                      committee members and the Central Bank of Malaysia, this
                      study delves into the practical experiences of governors
                      in carrying out the responsibilities of al-Siyasah
                      al-Shar‘iyyah within the decision-making process. The
                      objective is to investigate the perspectives
                    </p>
                  </div>
                </div>
                <div>
